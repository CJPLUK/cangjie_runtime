...
MRT_EXPORT void CJ_MCC_TaskInit(void* ptr);
__asm__(".global _CJ_MCC_TaskInit\n\t.set _CJ_MCC_TaskInit, _MCC_TaskInit");
MRT_EXPORT bool CJ_MCC_TaskIsComplete(const void* ptr);
__asm__(".global _CJ_MCC_TaskIsComplete\n\t.set _CJ_MCC_TaskIsComplete, _MCC_TaskIsComplete");
MRT_EXPORT void CJ_MCC_TaskNotifyAll(void* ptr);
__asm__(".global _CJ_MCC_TaskNotifyAll\n\t.set _CJ_MCC_TaskNotifyAll, _MCC_TaskNotifyAll");
MRT_EXPORT void CJ_MCC_TaskNotifyEndThread(void* ptr);
__asm__(".global _CJ_MCC_TaskNotifyEndThread\n\t.set _CJ_MCC_TaskNotifyEndThread, _MCC_TaskNotifyEndThread");
MRT_EXPORT bool CJ_MCC_TaskLockContinuationsOrAlreadyComplete(const void* ptr);
__asm__(".global _CJ_MCC_TaskLockContinuationsOrAlreadyComplete\n\t.set _CJ_MCC_TaskLockContinuationsOrAlreadyComplete, _MRT_TaskLockContinuationsOrAlreadyComplete");
MRT_EXPORT void CJ_MCC_TaskUnlockContinuations(const void* ptr);
__asm__(".global _CJ_MCC_TaskUnlockContinuations\n\t.set _CJ_MCC_TaskUnlockContinuations, _MRT_TaskUnlockContinuations");
MRT_EXPORT void CJ_MCC_TaskNotifyEndThread(void* ptr);
__asm__(".global _CJ_MCC_TaskNotifyEndThread\n\t.set _CJ_MCC_TaskNotifyEndThread, _MCC_TaskNotifyEndThread");
